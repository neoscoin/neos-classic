...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. NeosCoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    // neoscoin: links repeatedly have their payment requests routed to this process:
        ...
        {
            {
                ...
                // neoscoin: URIs or payment requests:
            ...
            // Shutdown the core and its threads, but don't exit NeosCoin-Qt here
