...
{ //  name                      actor (function)         okSafeMode threadSafe
  //  ------------------------  -----------------------  ---------- ----------
    ...
    { "getwalletinfo",          &getwalletinfo,          false,     false },
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: neoscoin-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
//
// JSON-RPC protocol.  NeosCoin speaks version 1.0 for maximum compatibility,
...
void StartRPCThreads()
{
    ...
    if (fUseSSL)
    {
        ...
        string strCiphers = GetArg("-rpcsslciphers", "TLSv1+HIGH:!SSLv3:!SSLv2:!aNULL:!eNULL:!AH:!3DES:@STRENGTH");
